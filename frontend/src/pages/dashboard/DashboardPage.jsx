...
function fmtTime(str) {
  if (!str) return ''
  return new Date(str).toLocaleTimeString('en-PK', { hour: 'numeric', minute: '2-digit' })
}
                        ...
                        <div className="dash-item-body">
                          ...
                          <div className="dash-item-sub">
                            ...
                            {v.consultation_fee > 0
                              ? <span className="dash-fee-tag">Rs. {Math.round(v.consultation_fee).toLocaleString('en-PK')}</span>
